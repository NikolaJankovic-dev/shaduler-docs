...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  ...
  <Tab value="npm">
    ```bash
    npx shadcn@latest add https://shaduler.vercel.app/r/shaduler.json
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    yarn dlx shadcn@latest add https://shaduler.vercel.app/r/shaduler.json
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bunx --bun shadcn@latest add https://shaduler.vercel.app/r/shaduler.json
    ```
  </Tab>
</Tabs>
